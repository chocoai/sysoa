	...
	<div class="ui container" style="background: #fff; min-height: 500px">
		...
		<div class="ui segment">
			<fieldset class="layui-elem-field layui-field-title">
				...
				<button class="positive ui button" onclick="javascript:history.go(-1)"
					style="float: right;">
			...
			<div class="ui horizontal segments">
				...
				<div class="ui right floated segment" style="width: 25%">
					...
					<%-- 					<div id="info-img-url" class="ui compact segments" title="点击查看大图"
						style=" background-image: url(${obj.info_img_url}) ; background-size: 100% 100%;">
						<div class="ui basic segment"></div>
						<div class="ui basic segment"
							style="background-color: rgba(0, 0, 0, 0.2); color: rgba(255.255 .255 .1);">
				...
				<!-- 	<div class="ui segment no-print">
					<button class="layui-btn layui-btn-primary layui-btn-mini" id="jq-print">打印</button>
					</div> -->
				</div>
			</div>
		...
		<input type="hidden" id="t_limit" value="${obj.require_finish_limit}">
		<input type="hidden" id="t_info_img_url" value="${obj.info_img_url}">
		<input type="hidden" id="t_progress_id" value="${obj.progress_id}">
		<input type="hidden" id="t_userflag" value="${flag}">
		<input type="hidden" id="t_supervise_info_con" value="${obj.supervise_info_con}">
		<input type="hidden" id="t_supervise_isfinish" value="${obj.isfinish}">
		<input type="hidden" id="t_curr_user_organizid" value="${organizid}">
